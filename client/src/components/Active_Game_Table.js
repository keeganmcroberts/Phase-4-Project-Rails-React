...
function ActiveGame() {
  ...
  function whenDrawingDeckisZero() {
    if (drawingDeckState < 80) setDrawingDeckState([completeDeck]);
  }
...
<div className="player-right">
      ...
      <br></br>
        ...
        {displayWildCard ? (
          <WildCardPopUp
            playedCardsState={playedCards}
            displayWildCard={setDisplayWildCard}
          />
        ) : null}
        </div>
